    ...
    $('span.slide-down').click(function(){
		...
		$('#cennik-container').tinyscrollbar_update('relative');
                ...
                if(ulList.is(':visible')) {
                    thisSpan.html('Zwiń');
                    thisSpan.css('background-image','url("/public/images/cennik-up-arrow.jpg")');
                } else {
                    thisSpan.html('Rozwiń');
                    thisSpan.css('background-image','url("/public/images/cennik-dropdown-arrow.jpg")');                    
                }
        });
    });
